...
public partial class FlyEaseDataBaseContextPrueba : DbContext
{
    public FlyEaseDataBaseContextPrueba()
    {
    }

    public FlyEaseDataBaseContextPrueba(DbContextOptions<FlyEaseDataBaseContextPrueba> options)
        : base(options)
    {
    }
