    ...
    where TContext : DbContext, new()
{
    ...
    [SwaggerResponse(StatusCodes.Status409Conflict,
        "Se ha generado un conflicto en la base de datos, por favor rectifica los datos que deseas ingresar",
        typeof(string))]
        ...
        try
        {
            ...
            if (mensaje == "Ok")
            {
                ...
                return StatusCode(StatusCodes.Status200OK,
                    new { mensaje = "Operación realizada con éxito", Success = true, response = entity });
            }

            return StatusCode(StatusCodes.Status409Conflict, new { mensaje, Success = false });
        }
        catch (Exception ex)
        {
    ...
    public virtual async Task<IActionResult> Delete(IdType Id)
    {
        try
        {
            ...
            if (mensaje == "Ok")
            {
                ...
                return StatusCode(StatusCodes.Status200OK,
                    new { mensaje = "Operación realizada con éxito", Success = true });
            }
